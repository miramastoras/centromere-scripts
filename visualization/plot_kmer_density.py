...
Creates a density plot of the k-mers from an input set along another sequence
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 4:
        print("usage: ./plot_kmer_density seq.fasta kmers.txt out_plot.png", file = sys.stderr)
        exit(1)

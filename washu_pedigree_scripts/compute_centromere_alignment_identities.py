...
Compute the alignment identities of possibly inherited centromere pairs
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("usage:\ncompute_centromere_alignment_identities.py aln_dir > identities.tsv", file = sys.stderr)
        sys.exit(1)

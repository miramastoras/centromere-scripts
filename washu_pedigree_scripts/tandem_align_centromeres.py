...
Run tandem_aligner on the identified centromere sequences
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        print("usage: ./tandem_align_centromeres child_prefix parent1_prefix parent2_prefix output_dir", file = sys.stderr)
        exit(1)

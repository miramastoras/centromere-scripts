...
Use summary of centromere flank alignments to extract active HOR arrays
from an assembly
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        print("usage: ./extract_active_array_from_flanks.py assembly.fasta flanks.tsv min_aln_coverage output_dir", file = sys.stderr)
        sys.exit(1)

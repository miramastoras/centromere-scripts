...
Extract the alpha satellite monomers from a sequence in one
FASTA per annotated family
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 4:
        print("usage: ./extract_monomers.py monomers.bed assembly.fasta output_dir", file = sys.stderr)
        exit(1)

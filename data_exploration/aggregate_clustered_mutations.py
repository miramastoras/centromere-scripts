...
Merges nearby variants in the output of construct_mutation_list.py
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("usage: ./aggregate_clustered_mutations.py muts.tsv > aggregated.tsv", file = sys.stderr)
        sys.exit(1)
